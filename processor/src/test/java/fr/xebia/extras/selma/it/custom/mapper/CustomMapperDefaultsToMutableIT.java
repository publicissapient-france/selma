 ...
 */
@Compile(withClasses = {CustomMutableMapper.class, CustomMapperDefaultsToMutable.class})
public class CustomMapperDefaultsToMutableIT extends IntegrationTestBase {
