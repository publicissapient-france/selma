 ...
 */
@Compile(withClasses = {
        EmbeddedFieldToUpperFieldUpdateGraphMapper.class
})
public class EmbeddedFieldToUpperFieldInMapsUpdateGraphIT extends IntegrationTestBase {
    ...
    public void given_a_mapper_with_custom_embeded_field_to_upper_field_mapping_should_use_described_name_to_name_for_mapping() throws Exception {
        // Given
        EmbeddedFieldToUpperFieldUpdateGraphMapper mapper = Selma.mapper(EmbeddedFieldToUpperFieldUpdateGraphMapper.class);
        ...
        // When
        ProposalDto proposalDto = mapper.asProposalDto(proposal, new ProposalDto());
    ...
    public void given_a_mapper_with_custom_upper_field_to_embedded_field_mapping_should_use_described_name_to_name_for_mapping() throws Exception {
        ...
        // When
        Proposal resProposal = mapper.asProposal(proposal, new Proposal());
