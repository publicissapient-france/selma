 ...
 *
 */
@Mapper(withCustom = NeverUsedMappingInterceptor.class, ignoreMissingProperties = true)
public interface MappingInterceptorInMaps {

    @Maps(withCustom = MappingInterceptorForImmutable.class)
