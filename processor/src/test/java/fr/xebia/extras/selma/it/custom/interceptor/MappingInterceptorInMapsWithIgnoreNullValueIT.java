...
public class MappingInterceptorInMapsWithIgnoreNullValueIT extends IntegrationTestBase {
    ...
    public void should_map_bean_with_custom_mapper() throws IllegalAccessException, InstantiationException, ClassNotFoundException {
        MappingInterceptorInMapsWithIgnoreNullValue mapper = Selma.getMapper(MappingInterceptorInMapsWithIgnoreNullValue.class);
    ...
    public void given_mapping_interceptor_in_mapper_overriden_in_maps_then_it_should_be_reported_unused_in_warnings() throws Exception {
        assertCompilationWarning(MappingInterceptorInMaps.class, "public interface MappingInterceptorInMapsWithIgnoreNullValue {",
