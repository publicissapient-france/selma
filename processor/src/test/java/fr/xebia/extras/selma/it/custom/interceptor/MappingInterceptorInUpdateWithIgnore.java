...
import fr.xebia.extras.selma.it.custom.interceptor.beans.CustomDateTimeInterceptor;
 ...
 */
@Mapper(
        withCyclicMapping = false,
        withIgnoreMissing = IgnoreMissing.ALL,
        withIgnoreNullValue = true)
public interface MappingInterceptorInUpdateWithIgnore {
