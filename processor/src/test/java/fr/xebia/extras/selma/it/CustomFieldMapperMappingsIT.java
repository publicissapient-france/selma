 ...
 */
@Compile(withClasses = {CustomFieldMappingsMapper.class})
public class CustomFieldMapperMappingsIT extends IntegrationTestBase {
    ...
    public void given_custom_fields_not_existing_for_class_compiler_should_report_warning() throws Exception {
        ...
        assertCompilationWarning(CustomFieldMappingsMapper.class, "public interface CustomFieldMappingsMapper {", "Custom @Field({\"classfieldfrom\",\"classfieldto\"}) mapping is never used !");
    }

    @Test
    public void given_custom_fields_not_existing_for_method_compiler_should_report_warning() throws Exception {

        assertCompilationWarning(CustomFieldMappingsMapper.class, "SimplePersonDto asPersonDtoReverseName(SimplePerson in);", "Custom @Field({\"methodfieldfrom\",\"methodfieldto\"}) mapping is never used !");
    }
