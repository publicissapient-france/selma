...
import fr.xebia.extras.selma.it.mappers.IgnoreFullyQualifiedNameClassFieldMappingsMapper;
import fr.xebia.extras.selma.it.mappers.IgnoreSimpleNameClassFieldMappingsMapper;
 ...
 *
 */
@Compile(withClasses = {IgnoreSimpleNameClassFieldMappingsMapper.class, IgnoreFullyQualifiedNameClassFieldMappingsMapper.class})
public class FullyQualifiedIgnoreFieldMappingsMapperIT extends IntegrationTestBase {
    ...
    public void given_simple_name_ignore_fields_for_in_bean_method_generated_mapper_should_ignore_them() {
        ...
        LibraryDTO res = Selma.getMapper(IgnoreSimpleNameClassFieldMappingsMapper.class).asLibraryDTO(in);
    ...
    public void given_explicit_ignore_fields_for_in_bean_generated_mapper_should_ignore_them() {
        ...
        LibraryDTO res = Selma.getMapper(IgnoreFullyQualifiedNameClassFieldMappingsMapper.class).asLibraryDTO(in);
    ...
    public void given_explicit_ignore_fields_for_out_bean_generated_mapper_should_ignore_them() {
        ...
        //When
        Library res = Selma.getMapper(IgnoreFullyQualifiedNameClassFieldMappingsMapper.class).asLibrary(in);
    ...
    public void given_simple_name_ignore_fields_for_out_bean_generated_mapper_should_ignore_them() {
        ...
        Library res = Selma.getMapper(IgnoreSimpleNameClassFieldMappingsMapper.class).asLibrary(in);
