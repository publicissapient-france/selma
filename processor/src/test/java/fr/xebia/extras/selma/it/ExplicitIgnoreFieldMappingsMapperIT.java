...
import fr.xebia.extras.selma.it.mappers.IgnoreFieldMappingsMapper;
 ...
 *
 */
@Compile(withClasses = IgnoreFieldMappingsMapper.class)
public class ExplicitIgnoreFieldMappingsMapperIT extends IntegrationTestBase {

    @Test
    public void given_explicit_ignore_fields_not_existing_for_class_compiler_should_report_warning() throws Exception {

        assertCompilationWarning(IgnoreFieldMappingsMapper.class, "public interface IgnoreFieldMappingsMapper {", "Ignored field \"notUsedClassField\" is never used");
    }

    @Test
    public void given_explicit_ignore_fields_not_existing_for_method_compiler_should_report_warning() throws Exception {

        assertCompilationWarning(IgnoreFieldMappingsMapper.class, "public interface IgnoreFieldMappingsMapper {", "Ignored field \"notUsedMethodField\" is never used");
    }
    ...
    public void given_explicit_ignore_fields_for_method_generated_mapper_should_ignore_them() {
        ...
        PersonOut res = Selma.getMapper(IgnoreFieldMappingsMapper.class).asPersonOut(in);
    ...
    public void given_explicit_ignore_fields_for_interface_generated_mapper_should_ignore_them() {
        ...
        in.setCapital(true);
        CityOut res = Selma.getMapper(IgnoreFieldMappingsMapper.class).asCityOut(in);
    ...
    public void given_explicit_ignore_fields_for_update_graph_method_generated_mapper_should_ignore_them() {
        ...
        PersonOut res = Selma.getMapper(IgnoreFieldMappingsMapper.class).asPersonOut(in, dest);
    ...
    public void given_explicit_ignore_fields_for_interface_on_update_graph_generated_mapper_should_ignore_them() {
        ...
        CityOut res = Selma.getMapper(IgnoreFieldMappingsMapper.class).asCityOut(in, dest);
